...
while fileindex < (filetotal + 1):
	...
	#n_segments values are looped for testing purposes, not created dynamically
	
	slic1 = slic(img1, n_segments , compactness=15, sigma=0.5, enforce_connectivity=1)
	...
	scipy.misc.imsave('n_seg' + str(n_segments) + '/' + str(filename) + '.png', out)	
